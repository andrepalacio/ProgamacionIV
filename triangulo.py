...
class Triangulo:
    ...
    def anazilar_casos(self, ladoA, ladoB):
    ...
    def analizar_triangulo(self):
        if self.lado1 == self.lado2 and self.lado1 == self.lado3:
            ...
            return self.anazilar_casos(self.lado2, self.lado3)
        elif self.lado2 == self.lado_mayor:
            return self.anazilar_casos(self.lado1, self.lado3)
        elif self.lado3 == self.lado_mayor:
            return self.anazilar_casos(self.lado1, self.lado2)
